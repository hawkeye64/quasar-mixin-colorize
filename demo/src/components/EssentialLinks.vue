<template>
  <q-list>
    <q-item clickable to="/docs">
      ...
      <q-item-section>
        <q-item-label>Colorize docs</q-item-label>
    ...
    <q-item clickable to="/demo">
      ...
      <q-item-section>
        <q-item-label>Colorize demo</q-item-label>
    ...
    <q-item clickable to="/examples">
      ...
      <q-item-section>
        <q-item-label>Colorize examples</q-item-label>
        <q-item-label caption>Examples of how to do it</q-item-label>
      </q-item-section>
    </q-item>
    <q-separator />
    <q-item clickable tag="a" target="_blank" href="https://github.com/hawkeye64/quasar-mixin-colorize">
      <q-item-section avatar>
